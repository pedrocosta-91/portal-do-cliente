...
import { ChevronLeft, MapPin, Printer, PlaneTakeoff, PlaneLanding } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[1440px] mx-auto px-8 py-8">
        ...
        <div className="flex gap-8 items-start">
          {/* Left Column - Payment Info & Passengers */}
          <div className="flex-1 flex flex-col gap-8">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-[1fr_80px_120px_120px] gap-4 py-3 border-b border-[#d9d9e0]">
                    <div className="text-sm text-[#60646c] leading-5">Passagem Econômica — Ida</div>
                    <div className="text-sm text-[#60646c] leading-5 text-center">2</div>
                    <div className="text-sm text-[#60646c] leading-5 text-center">1.500 tribz</div>
                    <div className="text-sm text-[#60646c] leading-5 text-right">3.000 tribz</div>
                  </div>

                  <div className="grid grid-cols-[1fr_80px_120px_120px] gap-4 py-3 border-b border-[#d9d9e0]">
                    <div className="text-sm text-[#60646c] leading-5">Passagem Econômica — Volta</div>
                    <div className="text-sm text-[#60646c] leading-5 text-center">2</div>
                    <div className="text-sm text-[#60646c] leading-5 text-center">1.400 tribz</div>
                    <div className="text-sm text-[#60646c] leading-5 text-right">2.800 tribz</div>
                  </div>
                </div>
                ...
                <div className="mt-4 space-y-2 ml-auto w-[240px]">
                  ...
                  <div className="border-t border-[#d9d9e0] pt-2 flex justify-between text-lg font-semibold leading-[26px]">
                    ...
                    <span className="text-[#1c2024]">6.380 tribz</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="border border-[#d9d9e0] rounded-lg p-4">
                    ...
                    <p className="text-2xl font-semibold text-[#1c2024] leading-8 mb-1">6.380 Tribz</p>
                  ...
                  <div className="border border-[#d9d9e0] rounded-lg p-4">
                    ...
                    <p className="text-2xl font-semibold text-[#1c2024] leading-8 mb-1">R$ 1.595,00</p>
                    <p className="text-sm text-[#60646c] leading-5">em 2x de R$ 797,50 sem juros</p>
                  </div>
                </div>
              </div>
            ...
            <div className="border border-[#d9d9e0] rounded-2xl p-6">
              ...
              <div className="grid grid-cols-2 gap-8">
                {/* Passenger 1 */}
                <div>
                  <p className="text-sm text-[#60646c] leading-5 mb-3">Passageiro 1</p>
                ...
                {/* Passenger 2 */}
                <div>
                  <p className="text-sm text-[#60646c] leading-5 mb-3">Passageiro 2</p>
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-[#1c2024] flex items-center justify-center text-white font-medium flex-shrink-0">
                      PC
                    </div>
          ...
          {/* Right Column - Status & Flight Summary */}
          <div className="w-[480px] flex-shrink-0 flex flex-col gap-6">
            ...
            <div className="bg-white border border-[#d9d9e0] rounded-2xl p-6 shadow-[0px_4px_16px_0px_rgba(0,0,0,0.1)] sticky top-8">
              ...
              <div className="flex items-center gap-2 mb-3">
                <PlaneTakeoff size={16} className="text-[#60646c]" strokeWidth={1.5} />
                <span className="text-sm text-[#60646c] leading-5">Passagem Aérea</span>
              </div>

              {/* Route */}
              <h3 className="text-lg font-semibold text-[#1c2024] leading-[26px] tracking-[-0.04px] mb-4">
                São Paulo → Miami
              </h3>
              ...
              <div className="border-t border-[#d9d9e0] pt-4 mb-4">
                {/* Flight Outbound */}
                <div className="mb-4">
                  <p className="text-sm text-[#60646c] leading-5 mb-2">Ida</p>
                  <div className="flex items-center gap-3">
                    <div className="flex flex-col items-center">
                      <span className="text-base font-semibold text-[#1c2024] leading-6">10:45</span>
                      <span className="text-xs text-[#60646c]">GRU</span>
                    </div>
                    <div className="flex-1 flex flex-col items-center gap-1">
                      <span className="text-xs text-[#60646c]">11h 30min</span>
                      <div className="w-full flex items-center gap-1">
                        <div className="flex-1 h-px bg-[#d9d9e0]"></div>
                        <PlaneTakeoff size={12} className="text-[#60646c]" strokeWidth={1.5} />
                        <div className="flex-1 h-px bg-[#d9d9e0]"></div>
                      </div>
                      <span className="text-xs text-[#60646c]">Direto</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-base font-semibold text-[#1c2024] leading-6">16:15</span>
                      <span className="text-xs text-[#60646c]">MIA</span>
                    </div>
                  </div>
                  <p className="text-xs text-[#60646c] mt-1">Qui, 28 dez 2023 · LATAM Airlines</p>
                </div>

                {/* Flight Return */}
                <div className="border-t border-[#d9d9e0] pt-4">
                  <p className="text-sm text-[#60646c] leading-5 mb-2">Volta</p>
                  <div className="flex items-center gap-3">
                    <div className="flex flex-col items-center">
                      <span className="text-base font-semibold text-[#1c2024] leading-6">09:00</span>
                      <span className="text-xs text-[#60646c]">MIA</span>
                    </div>
                    <div className="flex-1 flex flex-col items-center gap-1">
                      <span className="text-xs text-[#60646c]">11h 15min</span>
                      <div className="w-full flex items-center gap-1">
                        <div className="flex-1 h-px bg-[#d9d9e0]"></div>
                        <PlaneLanding size={12} className="text-[#60646c]" strokeWidth={1.5} />
                        <div className="flex-1 h-px bg-[#d9d9e0]"></div>
                      </div>
                      <span className="text-xs text-[#60646c]">Direto</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-base font-semibold text-[#1c2024] leading-6">20:15</span>
                      <span className="text-xs text-[#60646c]">GRU</span>
                    </div>
                  </div>
                  <p className="text-xs text-[#60646c] mt-1">Qui, 3 jan 2026 · LATAM Airlines</p>
                </div>
              </div>
              ...
              <div className="border-t border-[#d9d9e0] pt-4 mb-4">
                <div className="flex items-center gap-2">
                  <MapPin size={16} className="text-[#60646c]" strokeWidth={1.5} />
                  <span className="text-sm text-[#60646c] leading-5">2 passageiros · Classe Econômica</span>
                </div>
              </div>
